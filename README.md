...
- `photo-heat-pumps-galashiels.jpg` — air source heat pumps outside flats in Galashiels, Scottish Borders, by Jim Barton, [geograph.org.uk via Wikimedia Commons, CC BY-SA 2.0](https://commons.wikimedia.org/wiki/File:Heat_pumps,_Galashiels_-_geograph.org.uk_-_8098025.jpg); resized to 1200 px. One of the two hero photos (`.hero-pair`); credit lives in the caption. (An alternative, a single heat pump at a house near Cambridge by Andrew Fogg, CC BY 2.0, is at commons.wikimedia.org/wiki/File:Fridge_in_reverse_(51398066663).jpg.)
